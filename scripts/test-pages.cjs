...
const PAGES = [
  ...
  {
    path: "/financial-onboarding",
    name: "Financial Onboarding",
    requiresAuth: false,
  },
  {
    path: "/bankability-explainer",
    name: "Bankability Explainer",
    requiresAuth: false,
  },
...
function analyzeResponse(response, page) {
  ...
  if (
    body.includes("Cannot read properties of") ||
  ...
  if (
    ...
    body.includes("hydration mismatch")
  ) {
